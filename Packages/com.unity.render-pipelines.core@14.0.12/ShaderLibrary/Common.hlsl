...
float _MLS_Lightmaps_Blend_Factor;
...
#ifdef MLS_TEXTURE_ARRAYS_ON
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_32);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_64);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_128);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_256);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_512);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_1024);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_2048);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_4096);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Color_Array_8192);

    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_32);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_64);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_128);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_256);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_512);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_1024);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_2048);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_4096);
    TEXTURE2D_ARRAY(_MLS_Lightmap_Directional_Array_8192);

    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_32);
    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_64);
    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_128);
    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_256);
    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_512);
    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_1024);
    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_2048);
    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_4096);
    TEXTURE2D_ARRAY(_MLS_Lightmap_ShadowMask_Array_8192);

    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_32);
    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_64);
    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_128);
    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_256);
    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_512);
    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_1024);
    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_2048);
    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_4096);
    TEXTURE2D_ARRAY(_MLS_MainLight_Cookie_Array_8192);
    ...
    float4 _MLS_Reflection_Probe_Positions[100];
    int _MLS_Reflection_Probe_Count;
#else
    ...
    TEXTURE2D(_MLS_LightCookie_Main_Blend_From);
    TEXTURE2D(_MLS_LightCookie_Main_Blend_To);
#endif
...
float4 BlendTwoTextures(int lightmapType, float2 uv, float4 addObjectData)
{
    half4 textureFrom = half4(0, 0, 0, 0);
    half4 textureTo = half4(0, 0, 0, 0);
    
#ifdef MLS_TEXTURE_ARRAYS_ON
        int arrayIndex = round(addObjectData.x);
        int lmIndex = round(addObjectData.y);
    
        int indexFrom = (_MLS_CURRENT_LIGHTMAP_PAIR.x * _MLS_CURRENT_LIGHTMAP_PAIR.z) + lmIndex;
        int indexTo = (_MLS_CURRENT_LIGHTMAP_PAIR.y * _MLS_CURRENT_LIGHTMAP_PAIR.z) + lmIndex;
    
        int mainLightCookieIndexFrom = _MLS_CURRENT_LIGHTMAP_PAIR.x;
        int mainLightCookieIndexTo = _MLS_CURRENT_LIGHTMAP_PAIR.y;
#endif    
    ...
    switch (lightmapType)
    {
        case 0:
                ...
                {
                    case 0:
                        textureFrom = _MLS_Lightmap_Color_Array_32.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Color_Array_32.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 1:
                        textureFrom = _MLS_Lightmap_Color_Array_64.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Color_Array_64.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 2:
                        textureFrom = _MLS_Lightmap_Color_Array_128.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Color_Array_128.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 3:
                        textureFrom = _MLS_Lightmap_Color_Array_256.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Color_Array_256.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 4:
                        textureFrom = _MLS_Lightmap_Color_Array_512.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Color_Array_512.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 5:
                        textureFrom = _MLS_Lightmap_Color_Array_1024.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Color_Array_1024.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 6:
                        textureFrom = _MLS_Lightmap_Color_Array_2048.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Color_Array_2048.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 7:
                        textureFrom = _MLS_Lightmap_Color_Array_4096.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Color_Array_4096.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                }
#else
        ...
        case 1:
                ...
                {
                    case 0:
                        textureFrom = _MLS_Lightmap_Directional_Array_32.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Directional_Array_32.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 1:
                        textureFrom = _MLS_Lightmap_Directional_Array_64.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Directional_Array_64.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 2:
                        textureFrom = _MLS_Lightmap_Directional_Array_128.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Directional_Array_128.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 3:
                        textureFrom = _MLS_Lightmap_Directional_Array_256.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Directional_Array_256.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 4:
                        textureFrom = _MLS_Lightmap_Directional_Array_512.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Directional_Array_512.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 5:
                        textureFrom = _MLS_Lightmap_Directional_Array_1024.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Directional_Array_1024.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 6:
                        textureFrom = _MLS_Lightmap_Directional_Array_2048.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Directional_Array_2048.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 7:
                        textureFrom = _MLS_Lightmap_Directional_Array_4096.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_Directional_Array_4096.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                }
#else
        ...
        case 2:
                ...
                {
                    case 0:
                        textureFrom = _MLS_Lightmap_ShadowMask_Array_32.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_ShadowMask_Array_32.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 1:
                        textureFrom = _MLS_Lightmap_ShadowMask_Array_64.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_ShadowMask_Array_64.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 2:
                        textureFrom = _MLS_Lightmap_ShadowMask_Array_128.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_ShadowMask_Array_128.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 3:
                        textureFrom = _MLS_Lightmap_ShadowMask_Array_256.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_ShadowMask_Array_256.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 4:
                        textureFrom = _MLS_Lightmap_ShadowMask_Array_512.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_ShadowMask_Array_512.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 5:
                        textureFrom = _MLS_Lightmap_ShadowMask_Array_1024.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_ShadowMask_Array_1024.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 6:
                        textureFrom = _MLS_Lightmap_ShadowMask_Array_2048.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_ShadowMask_Array_2048.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                    case 7:
                        textureFrom = _MLS_Lightmap_ShadowMask_Array_4096.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexFrom));
                        textureTo = _MLS_Lightmap_ShadowMask_Array_4096.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, indexTo));
                        break;
                }
#else
        ...
        case 3:
                ...
                {
                    case 0:
                        textureFrom = _MLS_MainLight_Cookie_Array_32.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexFrom));
                        textureTo = _MLS_MainLight_Cookie_Array_32.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexTo));
                        break;
                    case 1:
                        textureFrom = _MLS_MainLight_Cookie_Array_64.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexFrom));
                        textureTo = _MLS_MainLight_Cookie_Array_64.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexTo));
                        break;
                    case 2:
                        textureFrom = _MLS_MainLight_Cookie_Array_128.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexFrom));
                        textureTo = _MLS_MainLight_Cookie_Array_128.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexTo));
                        break;
                    case 3:
                        textureFrom = _MLS_MainLight_Cookie_Array_256.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexFrom));
                        textureTo = _MLS_MainLight_Cookie_Array_256.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexTo));
                        break;
                    case 4:
                        textureFrom = _MLS_MainLight_Cookie_Array_512.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexFrom));
                        textureTo = _MLS_MainLight_Cookie_Array_512.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexTo));
                        break;
                    case 5:
                        textureFrom = _MLS_MainLight_Cookie_Array_1024.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexFrom));
                        textureTo = _MLS_MainLight_Cookie_Array_1024.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexTo));
                        break;
                    case 6:
                        textureFrom = _MLS_MainLight_Cookie_Array_2048.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexFrom));
                        textureTo = _MLS_MainLight_Cookie_Array_2048.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexTo));
                        break;
                    case 7:
                        textureFrom = _MLS_MainLight_Cookie_Array_4096.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexFrom));
                        textureTo = _MLS_MainLight_Cookie_Array_4096.Sample(mls_bilinear_clamp_sampler, float3(uv.xy, mainLightCookieIndexTo));
                        break;
                }
#else
            textureFrom = _MLS_LightCookie_Main_Blend_From.Sample(mls_bilinear_clamp_sampler, uv.xy);
            textureTo = _MLS_LightCookie_Main_Blend_To.Sample(mls_bilinear_clamp_sampler, uv.xy);
#endif
            break;
    }
...
{
    return BlendTwoTextures(lightmapType, uv, float4(0, 0, 0, 0));
}
...
#ifdef MLS_TEXTURE_ARRAYS_ON
float4 BlendBakeryRNM(int lightmapType, float2 uv, float4 addObjectData)
#else
...
float4 BlendTwoCubeTextures(int probeIndex, float3 reflection, half mip, float3 currentProbePosition)
{
    float4 textureFrom;
    float4 textureTo;
    float blendFactor;
        ...
        for (int i = 0; i < 9; i++)
        {
            if (FloatEquals(_MLS_Reflection_Probe_Positions[i].x, currentProbePosition.x) &&
                FloatEquals(_MLS_Reflection_Probe_Positions[i].y, currentProbePosition.y) &&
                FloatEquals(_MLS_Reflection_Probe_Positions[i].z, currentProbePosition.z)) 
            {
                arrayIndex = i;
                break;
            }
        ...
        int indexFrom = (round(_MLS_CURRENT_LIGHTMAP_PAIR.x) * _MLS_Reflection_Probe_Count) + arrayIndex;
        int indexTo = (round(_MLS_CURRENT_LIGHTMAP_PAIR.y) * _MLS_Reflection_Probe_Count) + arrayIndex;
#endif
    ...
    switch (probeIndex)
    {
        case 0:
#ifdef MLS_TEXTURE_ARRAYS_ON
                    textureFrom = _MLS_Cubemap_Array.SampleLevel(mls_bilinear_clamp_sampler, float4(reflection.xyz, indexFrom), mip);
                    textureTo = _MLS_Cubemap_Array.SampleLevel(mls_bilinear_clamp_sampler, float4(reflection.xyz, indexTo), mip);
#else
