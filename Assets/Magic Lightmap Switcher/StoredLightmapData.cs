...
namespace MagicLightmapSwitcher
{
    ...
    public class StoredLightmapData : ScriptableObject
    {
        ...
        public class GameObjectsData
        {
            ...
            //[SerializeField]
            //public List<ObjectShaderProperty> objectShaderProperties;
            //[SerializeField]
        ...
        {
            [System.Serializable]
            public class RendererShaderProperty
            {
                [SerializeField]
                public bool trackable;
                [SerializeField]
                ...
                public RendererShaderProperty(RendererShaderProperty copyFrom = null)
                {
                    if (copyFrom != null)
                    {
                        trackable = copyFrom.trackable;
            ...
            [SerializeField]
            public List<RendererShaderProperty> rendererShaderProperties = new List<RendererShaderProperty>();
            [SerializeField]
            public Material currentMaterial;
            [SerializeField]
        ...
        public class SkyboxSettings
        {
            ...
            [SerializeField]
            public List<SkyboxShaderProperty> skyboxShaderProperties = new List<SkyboxShaderProperty>();
            [SerializeField]
            public bool enabled;
            [SerializeField]
        ...
        public class CustomBlendableData
        {
            ...
            [System.Serializable]
            public class BlendableBoolFieldData
            {
                [SerializeField]
                public FieldInfo sourceField;
                [SerializeField]
            ...
            [SerializeField]
            public BlendableBoolFieldData[] blendableBoolFieldsDatas;
            [SerializeField]
            public bool foldoutEnabled;
        }
