...
namespace UnityEditor
{
    public class StandardShader_5_0 : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent useTextureArrays = new GUIContent("Use Texture Arrays", "" +
                "If enabled, the shader will use Texture2D and TextureCube Arrays to switch and blend lightmaps (this will automatically switch the shader target to 5.0)");            
        }
        ...
        MaterialProperty useTextureArrays = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            useTextureArrays = FindProperty("_MLS_USE_TEXTURE_ARRAYS", props);
        }
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.ShaderProperty(useTextureArrays, Styles.useTextureArrays);
                useTextureArrays.floatValue = switcherInstance.useTextureArrays ? 1 : 0;
